...
function WhatsappSidebar() {
  ...
  const handleCreateGroup = (e) => {
    ...
    const created = createContact({
      ...
      fecha_ult_conexion: `Grupo · ${selectedGroupMembers.length + 1} miembros`,
        ...
        {filteredContacts.length === 0 ? (
          ...
          filteredContacts.map((contact) => {
            ...
            const avatarStyle = contact.avatar ? {
              backgroundImage: `url(${contact.avatar})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundColor: contact.avatarColor || (contact.isGroup ? '#00a884' : '#3b82f6')
            } : {
            ...
            return (
              ...
              >
                <div className="contact-avatar" style={avatarStyle}>
                  {contact.avatar ? null : (contact.isGroup ? <span className="material-symbols-outlined" style={{ fontSize: '24px' }}>group</span> : initials)}
                </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div 
                            ...
                            style={contact.avatar ? { backgroundImage: `url(${contact.avatar})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundColor: contact.avatarColor || '#3b82f6' } : { backgroundColor: contact.avatarColor || '#3b82f6' }}
                          >
